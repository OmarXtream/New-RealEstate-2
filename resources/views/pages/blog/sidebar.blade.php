<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">اشهر المنشورات</h3>
        <ul class="collection">
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">الاقسام</h3>
        <ul>
...
<div class="card">
    <div class="card-content">
        <h3 class="font-18 m-t-0 bold uppercase">التاقس</h3>
